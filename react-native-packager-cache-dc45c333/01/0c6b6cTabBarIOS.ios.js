...
var requireNativeComponent=require('requireNativeComponent');var TabBarIOS=_wrapComponent('TabBarIOS')((_temp=_class=function(_React$Component){_inherits(TabBarIOS,_React$Component);function TabBarIOS(){_classCallCheck(this,TabBarIOS);return _possibleConstructorReturn(this,(TabBarIOS.__proto__||Object.getPrototypeOf(TabBarIOS)).apply(this,arguments));}_createClass(TabBarIOS,[{key:'render',value:function render()
...
}}]);return TabBarIOS;}(React.Component),_class.Item=TabBarItemIOS,_class.propTypes=_extends({},View.propTypes,{style:View.propTypes.style,unselectedTintColor:ColorPropType,tintColor:ColorPropType,barTintColor:ColorPropType,translucent:React.PropTypes.bool,itemPositioning:React.PropTypes.oneOf(['fill','center','auto'])}),_temp));
