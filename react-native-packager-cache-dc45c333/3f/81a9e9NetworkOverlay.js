...
var WebSocketInterceptor=require('WebSocketInterceptor');
var XHRInterceptor=require('XHRInterceptor');

var LISTVIEW_CELL_HEIGHT=15;
var SEPARATOR_THICKNESS=2;


var nextXHRId=0;var NetworkOverlay=_wrapComponent('NetworkOverlay')(function(_React$Component){_inherits(NetworkOverlay,_React$Component);
...
function NetworkOverlay(props){_classCallCheck(this,NetworkOverlay);var _this=_possibleConstructorReturn(this,(NetworkOverlay.__proto__||Object.getPrototypeOf(NetworkOverlay)).call(this,
props));
_this._requests=[];
...
}_createClass(NetworkOverlay,[{key:'_enableXHRInterception',value:function _enableXHRInterception()
