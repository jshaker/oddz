...
var KeyboardAvoidingView=_wrapComponent('_component')(React.createClass({displayName:'KeyboardAvoidingView',
mixins:[TimerMixin],
...
this.props,behavior=_props.behavior,children=_props.children,style=_props.style,props=_objectWithoutProperties(_props,['behavior','children','style']);
...
return(
React.createElement(View,_extends({ref:viewRef,style:[style,heightStyle],onLayout:this.onLayout},props),
children));
...
return(
React.createElement(View,_extends({ref:viewRef,style:style,onLayout:this.onLayout},props),
...
return(
React.createElement(View,_extends({ref:viewRef,style:[style,paddingStyle],onLayout:this.onLayout},props),
children));
...
default:
return(
React.createElement(View,_extends({ref:viewRef,onLayout:this.onLayout,style:style},props),
children));}
