...
timing:Animated.timing};var NavigationTransitioner=_wrapComponent('NavigationTransitioner')((_temp=_class=function(_React$Component){_inherits(NavigationTransitioner,_React$Component);
...
this._transitionProps=buildTransitionProps(nextProps,nextState);var
...
}}]);return NavigationTransitioner;}(React.Component),_class.propTypes={configureTransition:PropTypes.func,navigationState:NavigationPropTypes.navigationState.isRequired,onTransitionEnd:PropTypes.func,onTransitionStart:PropTypes.func,render:PropTypes.func.isRequired},_temp));
